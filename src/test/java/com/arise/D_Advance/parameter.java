...
public class parameter {
    ...
    @Test(priority = 3)
    public void getCreatedUserStory() throws IOException {
        Response response = RestAssured.given().baseUri(ReadPropertiesFile.readProperties("URL")).contentType(ContentType.JSON).header("Cookie", cookieValue)
                .pathParam("StoryId",issueId)
...
//Please let me know once you will get the idea about collection
    }
    }
